...
const ksac =
  "https://res.cloudinary.com/da3u4ukxz/image/upload/v1715837286/KSAC_logo_adc2vn.png";
const keslogo =
  "https://res.cloudinary.com/da3u4ukxz/image/upload/v1715837281/keslogo_deweab.png";
...
function NavbarProject() {
  ...
  return (
    <nav className="mx-auto rounded-none bg-transparent sticky box-shadow1 z-50 md:top-5 md:mb-8 lg:w-[78%] 2lg:w-[72%] xl:w-[65%] sm:w-[85%]  h-16 md:items-center text-center md:justify-between md:rounded-full sm:text-sm   md:font-bold">
        ...
        <div className="flex justify-between md:w-full md:justify-between md:px-16 px-8">
          <div className="flex w-full md:justify-between">
            ...
            <div className="hidden  md:text-[10px]  2lg:text-[12.5px]     xl:text-[14px] md:flex md:text-center">
              <Link
                to="/"
                className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px]  cursor-pointer mt-4  text-shadow   box-shadow2 px-2  text-white hover:text-fuchsia-500 start  "
              >
                HOME
              </Link>
              <Link
                to="/Aboutus"
                className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px] cursor-pointer px-2  text-shadow mt-4 box-shadow2  text-white hover:text-fuchsia-500 start transition duration-500"
              >
                ABOUT US
              </Link>
              <Link
              ...
              <Link
                to="/projects"
                className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px]  cursor-pointer text-shadow1 px-2 mt-4  box-shadow2  text-fuchsia-600 start transition duration-500"
              >
                PROJECTS
              </Link>
              <Link
                to="/achievement"
                className="xl:ml-[10px] lg:mx-[8px] mt-4  cursor-pointer box-shadow3 px-2 text-white hover:text-fuchsia-500 text-shadow start transition duration-500"
              >
                ACHIEVEMENTS
              </Link>
            </div>
          ...
          <div className="md:hidden flex items-center pt-2 pr-3">
            ...
            >
              <svg
                className="w-8 h-8 text-white hover:text-blue-500 transition-colors duration-300 ease-in-out"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
                <path
      ...
      <div
        className={`md:hidden bg-black mobile-menu ${
          menuVisible ? "" : "hidden"
        }`}
      >
        <ul className="">
          <li className="active">
            <Link
              to="/"
              className="block text-sm px-2 py-4 hover:bg-fuchsia-500 hover:font-semibold text-slate-300      transition duration-300 "
            >
              HOME
            </Link>
          </li>
          <li>
            <Link
              to="/aboutus"
              className="block  text-sm px-2 py-4 hover:bg-fuchsia-500  text-slate-300 hover:font-semibold border-slate-600 border-[0.5px]  transition duration-300"
            >
              ABOUT US
            </Link>
          </li>
          ...
          <li>
            <Link
              to="/projects"
              className="block text-sm px-2 py-4 bg-fuchsia-600 font-bold text-slate-300  border-slate-600 border-[0.5px]  transition duration-300 "
            >
              PROJECTS
            </Link>
          </li>
