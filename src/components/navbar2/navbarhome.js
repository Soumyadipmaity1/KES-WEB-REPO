...
function NavbarHome() {
    ...
    return (
        <nav className="mx-auto  bg-transparent sticky box-shadow1 z-50 md:top-5 md:mb-8  lg:w-[78%] xl:w-[65%] sm:w-[85%]  h-16 md:items-center text-center md:justify-between md:rounded-full sm:text-sm   md:font-bold">
                ...
                <div className="flex justify-between md:w-full md:justify-between md:px-16 px-8">
                    <div className="flex w-full md:justify-between">
                        ...
                        <div className="hidden  md:text-[10px]   xl:text-[14px] md:flex md:text-center">
                            <Link to="/" className="xl:mx-[12px] lg:mx-[8px]  cursor-pointer mt-4  text-shadow1   box-shadow2 px-2  text-green-500 start  ">HOME</Link>
                            <Link to="/Aboutus" className="xl:mx-[12px] lg:mx-[8px] cursor-pointer px-2  text-shadow mt-4 box-shadow2  text-white hover:text-green-400 start transition duration-500">ABOUT US</Link>
                            <Link to="/studentblogs" className="xl:mx-[12px] lg:mx-[8px] cursor-pointer px-2 mt-4 text-shadow box-shadow2 text-white hover:text-green-400 start transition duration-500  ">STUDENT BLOGS</Link>
                            <Link to="/projects" className="xl:mx-[12px] lg:mx-[8px]  cursor-pointer text-shadow px-2 mt-4  box-shadow2 text-white hover:text-green-400 start transition duration-500">PROJECTS</Link>
