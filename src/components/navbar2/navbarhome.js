        ...
        <div className="flex justify-between md:w-full md:justify-between md:px-16 px-8">
          <div className="flex w-full md:justify-between">
            ...
            <div className="hidden  md:text-[10px] 2lg:text-[12.5px]  xl:text-[14px] md:flex md:text-center">
              <Link
                to="/"
                className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px]  cursor-pointer mt-4  text-shadow1   box-shadow2 px-2  text-green-500 start  "
              >
                HOME
              </Link>
              <Link
                to="/Aboutus"
                className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px] cursor-pointer px-2  text-shadow mt-4 box-shadow2  text-white hover:text-green-400 start transition duration-500"
              >
                ABOUT US
              </Link>
              <Link
              ...
              <Link
                to="/projects"
                className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px]  cursor-pointer text-shadow px-2 mt-4  box-shadow2 text-white hover:text-green-400 start transition duration-500"
              >
                PROJECTS
              </Link>
              <Link
                to="/achievement"
                className="xl:ml-[10px] lg:mx-[8px] mt-4  cursor-pointer box-shadow3 px-2 text-white hover:text-green-400 text-shadow start transition duration-500"
              >
                ACHIEVEMENTS
              </Link>
            </div>
      ...
      >
        <ul className="">
          <li className="active">
            <Link
              to="/"
              className="block text-sm px-2 py-4 bg-green-700 text-white font-bold     transition duration-300 "
            >
              HOME
            </Link>
          </li>
          <li>
            <Link
              to="/aboutus"
              className="block  text-sm px-2 py-4 hover:bg-green-600  text-slate-300 hover:font-semibold border-slate-600 border-[0.5px]  transition duration-300"
            >
              ABOUT US
            </Link>
          </li>
