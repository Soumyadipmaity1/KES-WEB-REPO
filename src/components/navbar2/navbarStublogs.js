                ...
                <Link to="/">
                  ...
                  <li>
                    ...
                    <div className="hidden  md:text-[10px]  2lg:text-[12.5px]     xl:text-[14px] md:flex md:text-center">
                        ...
                        <Link to="/events" className="xl:mx-[12px] 2lg:mx-[10px] lg:mx-[8px] cursor-pointer px-2 mt-4 text-shadow1 box-shadow2 text-orange-500 start transition duration-500  ">EVENTS</Link>
    ...
    <button className="outline-none focus:outline-none" onClick={toggleMenu}>
        ...
        <div className={`md:hidden bg-black mobile-menu ${menuVisible ? '' : 'hidden'}`}>
            ...
            <li className="active"><Link to="/" className="block text-sm px-2 py-4 hover:bg-orange-500 text-slate-300 hover:font-semibold     transition duration-300 ">HOME</Link></li>
                ...
                <li><Link to="/events" className="block text-sm px-2 py-4  bg-orange-500 font-bold text-white  border-slate-600 border-[0.5px]  transition duration-300  ">EVENTS</Link></li>
