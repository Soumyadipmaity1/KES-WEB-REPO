...
function NavbarAboutus() {
    ...
    return (
        <nav className="mx-auto rounded-none bg-transparent sticky box-shadow1 box-shadow z-50 md:top-5 md:mb-8 lg:w-[78%] xl:w-[65%] sm:w-[85%]  h-16 md:items-center text-center md:justify-between md:rounded-full sm:text-sm   md:font-bold">
                ...
                <div className="flex justify-between md:w-full md:justify-between md:px-16 px-8">
                    <div className="flex w-full md:justify-between">
                        ...
                        <div className="hidden  md:text-[10px]   xl:text-[14px] md:flex md:text-center">
                            <Link to="/" className="xl:mx-[12px] lg:mx-[8px]  cursor-pointer mt-4  text-shadow  text-white box-shadow2 px-2  hover:text-blue-500 start  ">HOME</Link>
                            <Link to="/aboutus" className="xl:mx-[12px] lg:mx-[8px] cursor-pointer px-2  text-shadow1   mt-4 box-shadow2  text-blue-500 start transition duration-500">ABOUT US</Link>
                            <Link to="/studentblogs" className="xl:mx-[12px] lg:mx-[8px] cursor-pointer px-2 mt-4 text-shadow box-shadow2 text-white hover:text-blue-500 start transition duration-500  ">STUDENT BLOGS</Link>
                            <Link to="/projects" className="xl:mx-[12px] lg:mx-[8px]  cursor-pointer text-shadow px-2 mt-4  box-shadow2 text-white hover:text-blue-500 start transition duration-500">PROJECTS</Link>
        ...
        <svg className="w-8 h-8 text-white hover:text-blue-500 transition-colors duration-300 ease-in-out" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className={`md:hidden bg-black  mobile-menu ${menuVisible ? '' : 'hidden'}`}>
                <ul className="">
                    ...
                    <li><Link to="/studentblogs" className="block text-sm px-2 py-4  hover:bg-blue-600 hover:font-semibold text-slate-300  border-slate-600 border-[0.5px]  transition duration-300  ">STUDENT BLOGS</Link></li>
