  ...
  const items = [
    {
      ...
      className: "md:text-3xl text-2xl  md:p-2.5 md:px-3 p-1.5 px-2  border-2 border-white my-1 md:my-2 font-bold text-white bg-green-500", // Custom class for blue background and large icon size
      command: () => {
    ...
    },
    {
        ...
        className: "md:text-3xl text-2xl md:p-2.5 md:px-3 p-1.5 px-2 border-2 border-white my-1 md:my-2 font-bold text-white bg-pink-600", // Custom class for blue background and large icon size
        command: () => {
      ...
      {
        icon: "fab fa-youtube",
        className: "md:text-3xl text-2xl  md:p-2.5 md:px-2.5 p-1.5 px-1 border-2 border-white  my-1 md:my-2 font-bold text-white bg-red-600", // Custom class for blue background and large icon size
        command: () => {
      ...
      },
      {
        ...
        className: "md:text-3xl text-2xl  md:p-2.5 md:px-3 p-1.5 px-2 border-2 border-white my-1 md:my-2 font-bold text-white bg-blue-600", // Custom class for blue background and large icon size
        command: () => {
      ...
      },
      {
        ...
        className: "md:text-5xl text-4xl my-1 md:my-2  border-2 border-white   font-bold text-blue-500 bg-white", // Custom class for blue background and large icon size
        command: () => {
